 ...
 */
class PN_COOKIES_MANAGER_i18n {
	/**
	 * Load the plugin text domain for translation.
	 *
	 * @since    1.0.0
	 */
	public function pn_cookies_manager_load_plugin_textdomain() {
  ...
  public function pn_cookies_manager_timestamp_server_gap() {
  ...
  public static function pn_cookies_manager_get_post($post_id) {
  	// PN_COOKIES_MANAGER_i18n::pn_cookies_manager_get_post($post_id);
  ...
  public static function pn_cookies_manager_get_term($term_id) {
  	// PN_COOKIES_MANAGER_i18n::pn_cookies_manager_get_term($term_id);
